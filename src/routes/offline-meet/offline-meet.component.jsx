...
const OfflineMeet = () => {
    ...
    const mockArray = [{key:1,meetingRoomName:'test meeting room 1',capacity:50,location:'top floor east wing 12'},{key:2,meetingRoomName:'test meeting room 1',capacity:50,location:'top floor east wing 21'},{key:3,meetingRoomName:'test meeting room 1',capacity:50,location:'top floor east wing 112'},{key:4,meetingRoomName:'test meeting room 1',capacity:50,location:'top floor east wing 22'},{}]

    return ( 
        <div className="offline-meet-div">
            <h1>Offline Meetings</h1>
            <div className='adm-add-meet button-box-shadow' onClick={()=>setIsAddMeetingDialogOpen(true)}> <FaPlus/> add meeting room </div>
            <div className='container'>
                {mockArray.map(obj=>{
                    return <div className='tile main-box-shadow' key={obj.key}>
                        <div className='avatar-container'>
                        <Avatar name={`meet-room-tile-${obj.key}`} variant='marble' size={'100%'}  className='avatar-main' square />
                        </div>
